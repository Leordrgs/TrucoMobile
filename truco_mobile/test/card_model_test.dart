...
void main() {
  group(
      ...
      () => {
            test(
                'compareValue should return 1 if the value of the card is greater',
                () {
            ...
            test(
                'compareValue should return -1 if the value of the card is less',
                () {
            ...
            test(
                'compareValue should return 0 if the value of the card is equal',
                () {
              var card1 = Card(rank: 'A', suit: 'Ouros', value: 8);
              var card2 = Card(rank: 'A', suit: 'Ouros', value: 8);
